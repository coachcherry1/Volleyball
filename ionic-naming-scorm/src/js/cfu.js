...
var CFU = (function () {
  ...
  var BANK = [
    ...
    { id: 'tm12', tag: 'tm', min: 3, q: 'A student named CuO “copper oxide.” What is missing?',
    ...
    { id: 'tm13', tag: 'tm', min: 3, q: 'Why do FeCl₂ and FeCl₃ need different names?',
    ...
    { id: 'tm14', tag: 'tm', min: 4, q: 'What is the name of KMnO₄?',
    ...
    { id: 'tm15', tag: 'tm', min: 4, q: 'What is the name of Na₂CrO₄?',
    ...
    { id: 'tm16', tag: 'tm', min: 4, q: 'Does ammonium chloride, NH₄Cl, need a Roman numeral?',
    ...
    /* ----------------------------------------------------------- numeral */
    { id: 'nu1', tag: 'numeral', min: 3, q: 'What does the (III) in iron(III) oxide tell you?',
    ...
    { id: 'nu2', tag: 'numeral', min: 3, q: 'Which formula is iron(III) oxide?',
      a: ['Fe₂O₃', 'Fe₃O', 'FeO₃', 'Fe₃O₂'],
      why: 'Fe³⁺ and O²⁻: two Fe (6+) balance three O (6−). The III is a charge, not a subscript.' },
    { id: 'nu3', tag: 'numeral', min: 3, q: 'Which formula is copper(I) sulfide?',
      a: ['Cu₂S', 'CuS', 'CuS₂', 'Cu₁S'],
      why: 'Cu⁺ and S²⁻: it takes two Cu⁺ to balance one S²⁻.' },
    { id: 'nu4', tag: 'numeral', min: 3, q: 'Which formula is tin(IV) chloride?',
      a: ['SnCl₄', 'Sn₄Cl', 'SnCl₂', 'Sn₄Cl₄'],
      why: 'Sn⁴⁺ and Cl⁻: one Sn⁴⁺ needs four Cl⁻.' },
    { id: 'nu5', tag: 'numeral', min: 3, q: 'A student wrote Fe₃O for iron(III) oxide. What went wrong?',
    ...
    { id: 'nu6', tag: 'numeral', min: 3, q: 'Lead(II) and lead(IV) are…',
    ...
    /* ------------------------------------------------------------ charge */
    { id: 'ch1', tag: 'charge', min: 3, q: 'In PbO₂, what is the charge on the lead?',
      a: ['4+', '2+', '1+', '2−'],
    ...
    { id: 'ch2', tag: 'charge', min: 3, q: 'In Fe₂O₃, what is the charge on each iron?',
      a: ['3+', '2+', '6+', '3−'],
      why: 'Three O²⁻ make 6−. Two Fe share it: 3+ each → iron(III) oxide.' },
    { id: 'ch3', tag: 'charge', min: 3, q: 'In CuCl, what is the charge on the copper?',
      a: ['1+', '2+', '1−', '0'],
      why: 'One Cl⁻ is 1−, so one Cu balances it at 1+ → copper(I) chloride.' },
    { id: 'ch4', tag: 'charge', min: 3, q: 'What is the name of MnO₂?',
    ...
    { id: 'ch5', tag: 'charge', min: 3, q: 'To find a transition metal’s charge from a formula, you…',
    ...
    { id: 'ch6', tag: 'charge', min: 3, q: 'In SnS₂, why is the tin 4+ and not 2+?',
    ...
    { id: 'ch7', tag: 'charge', min: 4, q: 'In Fe(NO₃)₃, what is the charge on the iron?',
      a: ['3+', '1+', '9+', '2+'],
      why: 'Three NO₃⁻ ions make 3−. One Fe balances it: Fe³⁺ → iron(III) nitrate.' },
    { id: 'ch8', tag: 'charge', min: 4, q: 'In Sn(SO₄)₂, what is the charge on the tin?',
      a: ['4+', '2+', '1+', '8+'],
      why: 'Two SO₄²⁻ ions make 4−. One Sn balances it: tin(IV) sulfate.' },

    /* ------------------------------------------------------------ reduce */
    { id: 're1', tag: 'reduce', min: 3, q: 'Titanium(IV) ions and oxide ions combine. Which formula is correct?',
      a: ['TiO₂', 'Ti₂O₄', 'Ti₄O₂', 'TiO₄'],
      why: 'Ti⁴⁺ and O²⁻ criss-cross to Ti₂O₄, which reduces to TiO₂.' },
    { id: 're2', tag: 'reduce', min: 3, q: 'Why is Ti₂O₄ not an acceptable formula?',
    ...
    { id: 're3', tag: 'reduce', min: 3, q: 'Which formula is written in lowest terms?',
      a: ['CaS', 'Ca₂S₂', 'Mg₂O₂', 'Pb₂O₄'],
      why: 'Ca²⁺ and S²⁻ are already 1:1. The others can all be divided by 2.' },
    { id: 're4', tag: 'reduce', min: 4, q: 'Which is correct for sodium peroxide?',
      a: ['Na₂O₂', 'NaO', 'Na₂O', 'NaO₂'],
      why: 'Peroxide is O₂²⁻ — one ion. Two Na⁺ balance it: Na₂O₂. Never reduce the subscript inside a polyatomic ion.' },
    { id: 're5', tag: 'reduce', min: 4, q: 'Which is correct for tin(IV) sulfate?',
    ...
    /* ------------------------------------------------------------- paren */
    { id: 'pa1', tag: 'paren', min: 4, q: 'Which formula is correct for calcium nitrate?',
      a: ['Ca(NO₃)₂', 'CaNO₃₂', 'CaNO₃', 'Ca₂NO₃'],
      why: 'Ca²⁺ needs two NO₃⁻. More than one polyatomic ion → parentheses: Ca(NO₃)₂.' },
    { id: 'pa2', tag: 'paren', min: 4, q: 'When do you put parentheses around a polyatomic ion?',
    ...
    { id: 'pa3', tag: 'paren', min: 4, q: 'Which formula uses parentheses correctly?',
      a: ['Al₂(SO₄)₃', 'Ca(SO₄)', 'Na(NO₃)', '(Na)₂O'],
      why: 'Al₂(SO₄)₃ has three sulfates, so they need parentheses. The others have one polyatomic ion or none.' },
    { id: 'pa4', tag: 'paren', min: 4, q: 'How many oxygen atoms are in Fe(NO₃)₃?',
      a: ['9', '3', '4', '6'],
      why: 'The 3 outside the parentheses multiplies everything inside: 3 NO₃ = 3 N and 9 O.' },
    { id: 'pa5', tag: 'paren', min: 4, q: 'Why is MgOH₂ the wrong way to write magnesium hydroxide?',
    ...
    { id: 'po7', tag: 'poly', min: 4, q: 'Which formula is dichromate?',
      a: ['Cr₂O₇²⁻', 'CrO₄²⁻', 'Cr₂O₄²⁻', 'CrO₇²⁻'],
      why: 'Chromate is CrO₄²⁻; dichromate is Cr₂O₇²⁻. Both are 2−.' },
    { id: 'po8', tag: 'poly', min: 4, q: 'What is the difference between oxide and peroxide?',
    ...
    { id: 'po11', tag: 'poly', min: 4, q: 'What is the name of Fe(NO₃)₂?',
      a: ['iron(II) nitrate', 'iron(I) nitrate', 'iron(II) nitrite', 'iron nitrate'],
      why: 'Two NO₃⁻ make 2−, so the iron is 2+: iron(II) nitrate.' },
    { id: 'po12', tag: 'poly', min: 4, q: 'An -ate ion and the -ite ion of the same element differ by…',
    ...
    { id: 'po13', tag: 'poly', min: 4, q: 'What is the charge on the phosphite ion?',
      a: ['3−', '2−', '1−', '3+'], why: 'Phosphite is PO₃³⁻ — same 3− charge as phosphate, PO₄³⁻.' },
    { id: 'po14', tag: 'poly', min: 4, q: 'CN⁻ is…',
      a: ['cyanide', 'carbonate', 'nitride', 'carbide'],
      why: 'CN⁻ is cyanide. Carbonate is CO₃²⁻, and nitride is N³⁻.' },
    { id: 'po15', tag: 'poly', min: 4, q: 'What is the charge on the carbonate ion?',
